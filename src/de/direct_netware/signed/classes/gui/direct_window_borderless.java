...
NOTE_END //n*/
/**
* Enhanced version of JFrame without window decorations.
*
...
public class direct_window_borderless extends JFrame implements ComponentListener
{
	public static final long serialVersionUID = -8734722708191692817L;

	protected Component component_parent;
	protected Container container;

	public direct_window_borderless ()
	{
		super ();
		init ("Untitled",true);
	}

	public direct_window_borderless (Component f_component)
	{
		super ();
	...
	public direct_window_borderless (String f_title)
	{
		super ();
		init (f_title,true);
	}

	public direct_window_borderless (String f_title,Component f_component)
	{
		super ();
		component_parent = f_component;
		init (f_title,false);
	...
	protected void init (String f_title,boolean f_interactive)
	{
		...
		new direct_init (this,container,f_title,f_interactive);
	...
	public direct_container getManaged () { return new direct_container (container); }
